...
<form method="post" enctype="multipart/form-data">
    ...
    <button type="button" class="btn btn-secondary ms-2" onclick="batalPengaduan()">Kembali</button>
<button type="button" class="btn btn-success ms-2" onclick="window.location='histori.php'">
    Histori</button>
</form>
