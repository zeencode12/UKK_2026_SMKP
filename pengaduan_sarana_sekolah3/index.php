...
<style>
  ...
  background-attachment: fixed;  /* efek diam saat scroll */
}
  .navbar {
  ...
  <div class="row justify-content-center">
    <div class="col-md-4 mb-3">
      <div class="card shadow text-center">
        <div class="card-body">
          <image src="image/siswa.png"style="width:200px; height:200px;"/> 
    ...
    <div class="col-md-4 mb-3">
      <div class="card shadow text-center">
        <div class="card-body">
          <image src="image/admin.png"style="width:200px; height:200px;"/> 
